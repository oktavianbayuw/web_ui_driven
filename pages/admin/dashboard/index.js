          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            ...
            <div className="p-3 md:col-span-2 lg:col-span-1">
              ...
              <div className="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
                      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Visi Misi Universitas Tugu Muda</h5>
                  </a>
                  <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Kampus kami adalah tempat berkumpulnya orang-orang yang kreatif, dinamis, dan menginspirasi untuk tumbuh bersama.</p>
