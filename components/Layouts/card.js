...
const Card = ({ news }) => {
  return (
    <><div className="max-w-4xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img className="rounded-t-lg" src={news.image} alt={news.title} />
      </a>
      <div className="p-5">
        <a href="#">
