...
const benefitOne = {
  ...
  desc: "Kegiatan perkuliahan adalah proses pembelajaran yang meliputi kegiatan tatap muka di kelas, praktikum, penyelenggaraan percobaan dan pemberian tugas akademik lain.",
  image: kuliah,
  bullets: [],
};
